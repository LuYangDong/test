<?php
	...
	if(!empty($_GET["listid"])){
		$listid = $_GET["listid"];
		$sql = "SELECT * FROM ac_info WHERE ac_column='$listid' limit $star,$pageSize";
		$totsql  = "SELECT * FROM ac_info WHERE ac_column='$listid'";
	}else{
		$listid = "全部内容";
		$sql = "SELECT * FROM ac_info limit $star,$pageSize";
		$totsql  = "SELECT * FROM ac_info";	
	}
