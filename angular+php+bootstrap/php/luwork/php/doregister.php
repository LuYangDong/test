<?php
	...
	$sql = "INSERT INTO user_info(user_name,user_pass,user_email,user_phone,user_area,user_sex,user_hobby,user_date) VALUES ('$user','$pass','$email','$phone','$area','$sex','$hobyStr','$times')";
